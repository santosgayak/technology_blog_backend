...
function X(e, ...t) {
  ...
  const n = t.shift();
  if (L(e) && L(n)) for (const r in n) L(n[r]) ? (e[r] === void 0 && Object.assign(e, {
    [r]: {}
...
function $n(e, t) {
  ...
  for (var n = [e]; n.length > 0; ) {
    var r = n.shift();
    if (r) {
      if (e = r, (0, Nn.isLeaf)(e) && !(0, An.isNodeEmpty)(e, t)) return false;
...
function nr(e) {
  ...
  if (t === null || (0, T.isEmpty)(e)) return true;
  if ((0, T.isNativeInput)(t)) return t.selectionEnd === 0;
  if ((0, T.isEmpty)(e)) return true;
...
function ar() {
  ...
  if (t.id = "cursor", t.hidden = true, !!e) return e.insertNode(t), function() {
...
var f = class _f {
   ...
   */
  toggleCheckbox(t) {
    t.classList.toggle(_f.CSS.itemChecked), t.classList.add(_f.CSS.noHover), t.addEventListener("mouseleave", () => this.removeSpecialHoverBehavior(t), {
      once: true
    });
  }
  /**
...
var K = class {
  ...
  render() {
    ...
    }, false), "start" in this.data.meta && this.data.meta.start !== void 0 && this.changeStartWith(this.data.meta.start), "counterType" in this.data.meta && this.data.meta.counterType !== void 0 && this.changeCounters(this.data.meta.counterType), this.listWrapper;
  }
  /**
  ...
  convertItemToDefaultBlock(t, n) {
    ...
    n === true && this.api.blocks.delete(), t !== void 0 ? r = this.api.blocks.insert(void 0, {
      text: a
